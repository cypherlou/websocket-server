...
class Commands(object):
        ...
        for file in os.listdir(dir_path):
            ...
            if file.endswith(".py"):
                ...
                try:
                    ...
                    self.modules.append(
                        {
                            "module_location": full_path,
                            "module": instantiated,
                            "module_name": file,
                        }
                    )
                    self.modules_by_name[file] = {
                        "module_location": full_path,
                        "module": instantiated,
                        "module_name": file,
                    }
                    ...
                    self.log.error(
                        f"failed to dynamicly import {file} : {e} - omitting"
                    )
    ...
    def run(self, function, payload):
        ...
        if not func:
            response = {
                "success": False,
                "reason": "Can't find function '{}'".format(function),
                "detail": "None of the loaded classes contain this method",
            }
            ...
            try:
                ...
                response = {
                    "success": False,
                    "reason": "Failed to execute {}".format(function),
                    "detail": str(e),
                }
    ...
    def _module_by_name(self, module, function, payload):
        self.log.debug(
            "looking for function '{}' in module '{}'".format(function, module)
        )
        func = None
    ...
    def missing_function(self, payload):
        ...
        return {"reason": "request missing from payload - no function executed"}
